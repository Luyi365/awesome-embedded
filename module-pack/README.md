...
**链接**：[cproape/toolkit: ToolKit 是一套应用于嵌入式系统的通用工具包，目前为止工具包包含：循环队列、软件定时器、事件集](https://github.com/cproape/toolkit)  
...
**链接**：[MaJerle/lwutil: Versatile and easy to use C language utility library with functions and macros commonly used in various applications](https://github.com/MaJerle/lwutil)  
...
**链接**：[tezc/sc: Common libraries and data structures for C.](https://github.com/tezc/sc)  
...
- 使用介绍：[一个面向嵌入式系统的轻量级框架！](https://mp.weixin.qq.com/s/NwOgiCFkIlwgkIqK6_n_vg)
...
**链接**：[54zorb/Zorb-Framework: 一个轻量级嵌入式框架](https://github.com/54zorb/Zorb-Framework)  
**特征**：轻量级的嵌入式框架，包含基本的内核功能，都是单独集成，方便裁剪使用。  

#### 要点

- 使用介绍：[嵌入式框架 | 搭建调试输出、建立时间系统](https://mp.weixin.qq.com/s/xotrxGumAE-igqtomA_lfw)
- 环形缓冲区功能介绍：[嵌入式框架 | 环形缓冲区的实现](https://mp.weixin.qq.com/s/6nQjsxiB20p3xFca3f-jFw)
- 函数式状态机功能介绍：[嵌入式框架 | 状态机的实现](https://mp.weixin.qq.com/s/bgwvDfTEYN2W2tWi0z6eyA)
...
**链接**：[C Algorithms](https://fragglet.github.io/c-algorithms/)  
...
**链接**：[Klib — a generic library in C](https://attractivechaos.github.io/klib/#About)  
...
**链接**：[The Algorithms](https://github.com/TheAlgorithms/)  
**特征**：开源组织 TheAlgorithms 维护的各种基础算法、数据结构、机器学习等库，内容十分丰富，且包含各个流行语言的版本。  

#### 要点

- C/C++ 库基于 C11 版本编写，不依赖其他外部库，因此可以方便用于嵌入式领域。
...
**链接**：[wujique/PetiteDrv: a petite driver base on mcu such as stm32(f103/f407/h750), RT1052](https://github.com/wujique/PetiteDrv)  
